  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">FIFA World Cup 2026</h1>

        <h2 className="text-2xl font-bold mb-6 text-green-400">Group Stage</h2>
                  ...
                  <tbody>
                    {Array.from(teamsMap.values()).map((team: any) => (
                      ...
                      >
                        ...
                        <td className="text-center px-2 py-2 font-bold">0</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
